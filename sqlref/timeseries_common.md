...
```
SELECT TIME_SERIES(timetick, value) as ts FROM cos://us-geo/bucket5/in47.parquet STORED AS PARQUET INTO cos://us-geo/sql/timeseries.parquet STORED AS PARQUET
```
