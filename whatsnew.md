...
- {{site.data.keyword.cos_full_notm}} web console does now discover SQL-queryable objects and folders and allows to directly launch the {{site.data.keyword.sqlquery_short}} web console with an accordingly prefilled SQL statement for seamless interactive data exploration.
